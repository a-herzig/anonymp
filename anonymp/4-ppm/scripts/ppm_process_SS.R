...
## Share data
summation_path <- paste("outbox/4-ppm-6-summation-chunk", chunk_name, ".Rdata", sep = "")
...
saveRDS(list(full_shuffle_key_order = full_shuffle_key_order_w_row_shuffle), summation_path)
