...
cp tmp/chunks_anon.txt outbox/1-user-6-summation-chunks.txt
...
parallel --max-procs $CORES --colsep ' ' Rscript scripts/user_process_init_SS.R :::: tmp/chunks.txt
...
tarc -f pack-1-user-6-summation.tar.gz 1-user-6-summation-*
