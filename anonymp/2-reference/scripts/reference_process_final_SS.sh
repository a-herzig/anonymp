...
parallel --max-procs $CORES Rscript scripts/reference_process_final_SS.R :::: inbox/1-user-2-reference-chunks.txt
...
tarc -f pack-2-reference-6-summation.tar.gz 6-summation-5-product-*
